...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__25254_SHARP_){
return ((p1__25254_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__25254_SHARP_ === 'string');
}),class$__$1))){
...
var G__25256 = attrs;
var G__25256__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(attrs))?cljs.core.update_in.call(null,G__25256,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$):G__25256);
return G__25256__$1;
});
/**
...
var len__17863__auto___25260 = arguments.length;
var i__17864__auto___25261 = (0);
while(true){
if((i__17864__auto___25261 < len__17863__auto___25260)){
args__17870__auto__.push((arguments[i__17864__auto___25261]));

var G__25262 = (i__17864__auto___25261 + (1));
i__17864__auto___25261 = G__25262;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__17871__auto__);
});
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,p1__25257_SHARP_);
});})(maps__$1))
...
var G__25259 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
var G__25259__$1 = ((!(cljs.core.empty_QMARK_.call(null,classes__$1)))?cljs.core.assoc.call(null,G__25259,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1):G__25259);
return G__25259__$1;
});

sablono.normalize.merge_with_class.cljs$lang$maxFixedArity = (0);

sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq25258){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq25258));
});
/**
...
var vec__25266 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__25266,(0),null);
var names = cljs.core.nth.call(null,vec__25266,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25266,tag_name,names){
return (function (p1__25263_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__25263_SHARP_));
});})(matches,vec__25266,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__25266,tag_name,names){
return (function (p1__25264_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__25264_SHARP_));
});})(matches,vec__25266,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__25267){
var vec__25270 = p__25267;
var tag = cljs.core.nth.call(null,vec__25270,(0),null);
var content = cljs.core.nthnext.call(null,vec__25270,(1));
...
var vec__25271 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__25271,(0),null);
var id = cljs.core.nth.call(null,vec__25271,(1),null);
var class$ = cljs.core.nth.call(null,vec__25271,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1455030509846