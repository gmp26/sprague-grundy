...
var args26679 = [];
var len__17863__auto___26683 = arguments.length;
var i__17864__auto___26684 = (0);
while(true){
if((i__17864__auto___26684 < len__17863__auto___26683)){
args26679.push((arguments[i__17864__auto___26684]));

var G__26685 = (i__17864__auto___26684 + (1));
i__17864__auto___26684 = G__26685;
continue;
} else {
}
break;
...
var G__26682__$1 = ((cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter))?cljs.core.assoc.call(null,G__26682,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint):G__26682);
return G__26682__$1;
});
...
var or__16805__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__17863__auto___26690 = arguments.length;
var i__17864__auto___26691 = (0);
while(true){
if((i__17864__auto___26691 < len__17863__auto___26690)){
args__17870__auto__.push((arguments[i__17864__auto___26691]));

var G__26692 = (i__17864__auto___26691 + (1));
i__17864__auto___26691 = G__26692;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__17871__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq26687){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__26688,G__26689,seq26687__$2);
});
...
var file = cljs.core.get.call(null,map__26696__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26696__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26696__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__26696,map__26696__$1,file,line,column){
return (function (p1__26693_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__26693_SHARP_));
});})(map__26696,map__26696__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__17718__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__17718__auto__,prefer_table__17719__auto__,method_cache__17720__auto__,cached_hierarchy__17721__auto__,hierarchy__17722__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__16805__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__16805__auto__)){
return or__16805__auto__;
} else {
...
var temp__4425__auto___26698 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___26698)){
var message_26699 = temp__4425__auto___26698;
cljs.core.println.call(null,message_26699);
} else {
}
...
var temp__4425__auto___26700 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4425__auto___26700)){
var message_26701 = temp__4425__auto___26700;
cljs.core.println.call(null,message_26701);
} else {
}
...
var temp__4423__auto__ = (function (){var and__16793__auto__ = typeof exception.stack === 'string';
if(and__16793__auto__){
var G__26707 = exception.stack;
var G__26707__$1 = (((G__26707 == null))?null:clojure.string.split_lines.call(null,G__26707));
var G__26707__$2 = (((G__26707__$1 == null))?null:cljs.core.get.call(null,G__26707__$1,depth));
var G__26707__$3 = (((G__26707__$2 == null))?null:clojure.string.trim.call(null,G__26707__$2));
return G__26707__$3;
} else {
...
var vec__26708 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__26708,(0),null);
var column = cljs.core.nth.call(null,vec__26708,(1),null);
var vec__26709 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__26709,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__26709,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__26709,(2),null);
...
var m__$1 = (function (){var G__26711 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__26711) {
case "fail":
...
var G__26717 = (function (){var G__26716 = cljs.core.rest.call(null,fns);
var G__26716__$1 = (cljs.core.truth_(new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,obj)))?cljs.core.concat.call(null,obj,G__26716):G__26716);
return G__26716__$1;
})();
fns = G__26717;
continue;
...
var G__26719 = fns;
var G__26719__$1 = (((G__26719 == null))?null:cljs.core.vary_meta.call(null,G__26719,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true));
return G__26719__$1;
});
...
}catch (e26722){var e = e26722;
var G__26723 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__26723) {
...
var vec__26726 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__26726,(0),null);
var types = vec__26726;
...
return cljs.core.map.call(null,(function (p__26734){
var vec__26735 = p__26734;
var ns = cljs.core.nth.call(null,vec__26735,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__26735,(1),null);
return ((function (vec__26735,ns,vars__$1){
return (function (){
...
var G__26736 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__26736) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1){
return (function (){
var seq__26737 = cljs.core.seq.call(null,vars__$1);
var chunk__26738 = null;
var count__26739 = (0);
var i__26740 = (0);
while(true){
if((i__26740 < count__26739)){
var v = cljs.core._nth.call(null,chunk__26738,i__26740);
var temp__4425__auto___26742 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___26742)){
var t_26743 = temp__4425__auto___26742;
each_fixture_fn.call(null,((function (seq__26737,chunk__26738,count__26739,i__26740,t_26743,temp__4425__auto___26742,v,each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1){
return (function (){
...
});})(seq__26737,chunk__26738,count__26739,i__26740,t_26743,temp__4425__auto___26742,v,each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1))
);
} else {
}

var G__26744 = seq__26737;
var G__26745 = chunk__26738;
var G__26746 = count__26739;
var G__26747 = (i__26740 + (1));
seq__26737 = G__26744;
chunk__26738 = G__26745;
count__26739 = G__26746;
i__26740 = G__26747;
continue;
} else {
var temp__4425__auto__ = cljs.core.seq.call(null,seq__26737);
if(temp__4425__auto__){
var seq__26737__$1 = temp__4425__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__26737__$1)){
var c__17608__auto__ = cljs.core.chunk_first.call(null,seq__26737__$1);
var G__26748 = cljs.core.chunk_rest.call(null,seq__26737__$1);
var G__26749 = c__17608__auto__;
var G__26750 = cljs.core.count.call(null,c__17608__auto__);
var G__26751 = (0);
seq__26737 = G__26748;
chunk__26738 = G__26749;
count__26739 = G__26750;
i__26740 = G__26751;
continue;
} else {
var v = cljs.core.first.call(null,seq__26737__$1);
var temp__4425__auto___26752__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4425__auto___26752__$1)){
var t_26753 = temp__4425__auto___26752__$1;
each_fixture_fn.call(null,((function (seq__26737,chunk__26738,count__26739,i__26740,t_26753,temp__4425__auto___26752__$1,v,seq__26737__$1,temp__4425__auto__,each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_26753)));
});})(seq__26737,chunk__26738,count__26739,i__26740,t_26753,temp__4425__auto___26752__$1,v,seq__26737__$1,temp__4425__auto__,each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1))
);
} else {
}

var G__26754 = cljs.core.next.call(null,seq__26737__$1);
var G__26755 = null;
var G__26756 = (0);
var G__26757 = (0);
seq__26737 = G__26754;
chunk__26738 = G__26755;
count__26739 = G__26756;
i__26740 = G__26757;
continue;
}
} else {
...
});})(each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1))
);
});})(each_fixture_fn,G__26736,env,once_fixtures,each_fixtures,vec__26735,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1455030510800